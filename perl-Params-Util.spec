...
Version  : 1.100
Release  : 38
URL      : https://cpan.metacpan.org/authors/id/R/RE/REHSACK/Params-Util-1.100.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/R/RE/REHSACK/Params-Util-1.100.tar.gz
...
%prep
%setup -q -n Params-Util-1.100
cd %{_builddir}
tar xf %{_sourcedir}/libio-handle-util-perl_0.01-2.debian.tar.xz
cd %{_builddir}/Params-Util-1.100
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Params-Util-1.100/deblicense/
